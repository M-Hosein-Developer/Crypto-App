...
import com.example.application.databinding.MarketfragRvItemBinding;
...
public class marketRv_Adapter extends RecyclerView.Adapter<marketRv_Adapter.MarketRV_Holder> {
    ...
    public void onBindViewHolder(MarketRV_Holder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.marketfragRvItemBinding.marketRVCon.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Bundle bundle = new Bundle();
                bundle.putParcelable("bookmark",dataItems.get(position));

                Navigation.findNavController(v).navigate(R.id.action_marketFragment_to_watchListFragment , bundle);
