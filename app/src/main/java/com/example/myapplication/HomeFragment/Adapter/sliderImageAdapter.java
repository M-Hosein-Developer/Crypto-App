...
import com.example.application.databinding.SliderImageItemBinding;
...
public class sliderImageAdapter extends RecyclerView.Adapter<sliderImageAdapter.SliderImageViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull sliderImageAdapter.SliderImageViewHolder holder, int position) {
    ...
    static class SliderImageViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(int photo){
            ...
            Glide.with(sliderImageItemBinding.getRoot().getContext()).load(photo)
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                    .into(sliderImageItemBinding.imageSlider);
